    ...
    <div className="w-full h-full flex flex-col bg-white border-r border-gray-150/60">
      ...
      <div className="px-4 pb-3 relative shrink-0 flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={() =>
            setListMode(listMode === "unread" ? "chats" : "unread")
          }
      ...
      {listMode === "chats" && (
        <div className="px-4 pb-2 shrink-0">
          ...
          >
            ...
            <span className="text-[11px] font-bold text-gray-400 group-hover:text-[#1e2229] transition-colors">
              Archived
            </span>
          </button>
        </div>
      ...
      <div className="flex-grow overflow-y-auto pb-4 mt-1 flex flex-col">
        ...
        {listMode === "unread" &&
          (unreadChats.length === 0 ? (
            <div className="flex-grow flex items-center justify-center py-20 select-none animate-fade-in">
              <span className="text-[11px] font-bold text-[#9fa4b3]">
                No Unread Messages
              </span>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex justify-between items-baseline mb-0.5">
                        <h4
                          className={`text-[12px] font-bold truncate ${isSelected ? "text-white" : "text-[#1e2229]"}`}
                        >
                          {item.name}
                        </h4>
                        <span
                          className={`text-[9px] font-medium ${isSelected ? "text-blue-100" : "text-[#9fa4b3]"}`}
                        >
                          {item.time}
                        </span>
                      </div>
                      <div className="flex justify-between items-center gap-1">
                        <p
                          className={`text-[11px] truncate ${isSelected ? "text-blue-50" : "text-[#848a9e]"}`}
                        >
                          {item.msg}
                        </p>
                        <span className="w-4 h-4 rounded-full flex items-center justify-center bg-blue-500 text-white text-[9px] font-bold">
                          !
                        </span>
                      </div>
                    </div>
        ...
        {listMode === "chats" && (
          <div className="space-y-4 animate-fade-in">
            {/* Pinned Category */}
             <div>
              {/* <div className="px-5 pb-1.5 text-[9px] font-bold text-[#9fa4b3] uppercase tracking-widest">
                Pinned
              </div> */}
