  ...
  return (
    <div className="w-full h-full bg-white flex flex-col p-6 border-r border-gray-200">
      ...
      <div className="space-y-6 flex-grow">
        {/* Name Input */}
        <div>
          <label className="block text-xs font-bold text-blue-500 mb-1 tracking-wide uppercase">
            Your Name
          </label>
          <input
            type="text"
        ...
        <div className="relative">
          <label className="block text-xs font-bold text-gray-400 mb-1 tracking-wide uppercase">
            About
          </label>
          <textarea
            rows={5}
          ...
          <div className="flex justify-end mt-2">
            <button className="px-6 py-2 bg-[#3b82f6] text-white rounded-lg font-semibold text-xs shadow-md hover:bg-blue-600 transition-colors">
              Save
            </button>
          </div>
        </div>
